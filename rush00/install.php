...
if(TRUE )
{
	$sql = "CREATE TABLE vente (id INT UNSIGNED AUTO_INCREMENT PRIMARY KEY, article VARCHAR (50) NOT NULL, variete VARCHAR (50) NOT NULL, 
		prix INT NOT NULL, total INT NOT NULL, quantite INT NOT NULL, panier BOOL, vendu BOOL, livre BOOL, membre VARCHAR (255), connected BOOL)";
	if (mysqli_query($conn, $sql))
	{
		echo "table vente ok \n";
	}
